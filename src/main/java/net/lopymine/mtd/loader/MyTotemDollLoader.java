...
public class MyTotemDollLoader {
	...
	public static <S extends PictureInPictureRenderState> void registerPictureInPictureRenderer(Class<S> stateClass, Function<BufferSource, PictureInPictureRenderer<S>> factory) {
...
public class MyTotemDollLoader {
	...
	public static String getModVersion(String modid) {
		return FMLLoader.getCurrent().getLoadingModList().getModFileById(modid).getMods().get(0).getVersion().toString();
	}
